...
public class ProfessorController
{
    ...
    public void createSession( @RequestParam("exam_id") long exam_id,
                               @RequestBody SessionRequest session )
    {
        System.out.println( "ID: " + exam_id + ", SESSION: " + session );
        professor_service.createSession( exam_id, session );
    }
}
